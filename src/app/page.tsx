...
//   // Handle Like
//   const handleLike = async (docId: string, likedBy: string[]) => {
//     try {
//       if (!userId) throw new Error("User not logged in");
...
//           <div
//             key={item.id}
//             className="bg-gray-800 rounded-md shadow-lg p-4 text-center"
//           >
//             <img
//               src={item.imageUrl}
//               alt={item.prompt}
...
//                 item.likedBy?.includes(userId) ? "bg-red-500" : "bg-gray-700"
//               }`}
//             >
...
//                   : (item.likes || 0) + 1,
//                 likedBy: hasLiked
//                   ? (item.likedBy || []).filter((id: string) => id !== userId)
//                   : [...(item.likedBy || []), userId],
//               }
//             : item
//         )
...
//                 item.likedBy?.includes(userId) ? "bg-red-500" : "bg-gray-700"
//               }`}
//               disabled={loadingStates[image.id]} // Optional: Disable button during processing
//             >
//               {item.likedBy?.includes(userId) ? "❤️ Liked" : "🤍 Like"}
//             </button>
